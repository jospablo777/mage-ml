...
RESTART_STREAMING_PIPELINES_ON_REQUIREMENTS_CHANGE = get_bool_value(
    os.getenv('MAGE_RESTART_STREAMING_PIPELINES_ON_REQUIREMENTS_CHANGE', 'False')
)
...
MAGE_SETTINGS_ENVIRONMENT_VARIABLES = [
    ...
    'MAGE_RESTART_STREAMING_PIPELINES_ON_REQUIREMENTS_CHANGE',
